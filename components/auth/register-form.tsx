        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="mt-8">
                ...
                <div className="mt-6 grid grid-cols-2 gap-3">
                    <button
                        type="button"
                        className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-input rounded-xl shadow-sm bg-background/50 text-sm font-medium text-foreground hover:bg-muted/50 transition-colors"
                    >
                    ...
                    <button
                        ...
                        className="w-full inline-flex justify-center items-center py-2.5 px-4 border border-input rounded-xl shadow-sm bg-background/50 text-sm font-medium text-foreground hover:bg-muted/50 transition-colors"
                    >
                        <svg className="h-5 w-5 mr-2 fill-foreground" viewBox="0 0 24 24">
