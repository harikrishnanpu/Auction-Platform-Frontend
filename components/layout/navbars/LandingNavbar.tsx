      ...
      <nav className="w-full py-6 px-6 md:px-12 flex justify-between items-center z-50 relative">
          ...
          <Logo />
              ...
              <div className="flex items-center space-x-4">
                <Link className="hidden md:block text-sm font-medium hover:text-gray-600 dark:hover:text-gray-300 transition-colors" href="/login">Log In</Link>
                <Link className="bg-gray-900 hover:bg-gray-800 text-white px-5 py-2 rounded-full text-sm font-medium transition-colors shadow-md" href="/register">Get Started</Link>
               <ModeToggle />
              </div>
            </nav>
  )
