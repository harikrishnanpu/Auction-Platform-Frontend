...
import { ScanFace, Camera, RefreshCw, CheckCircle, Loader2 } from "lucide-react";
...
export function LivenessCheck({ isCompleted, onComplete }: LivenessCheckProps) {
    ...
    if (isCompleted) {
        return (
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-green-200 dark:border-green-900 bg-green-50 dark:bg-green-900/10">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h3 className="text-lg font-bold text-green-700 dark:text-green-400">Verification Complete</h3>
                        <p className="text-sm text-green-600 dark:text-green-500">Your liveness check has been verified successfully.</p>
                    </div>
                </div>
            </div>
        );
                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-center">
                        ...
                        <div className="flex-1">
                            ...
                            <div className="flex gap-3">
                                <Button onClick={() => setIsCameraOpen(true)} className="bg-foreground text-background">
