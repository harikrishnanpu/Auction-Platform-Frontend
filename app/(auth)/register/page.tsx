      ...
      <main className="min-h-screen flex items-center justify-center p-4 py-20 relative">
        ...
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center relative z-10">
          ...
          <div className="relative">
            ...
            <div className="bg-card/80 backdrop-blur-xl border border-border rounded-4xl shadow-2xl p-8 md:p-12 w-full relative overflow-hidden animate-in slide-in-from-bottom-10 duration-700 fade-in delay-200">
              <div className="mb-8">
