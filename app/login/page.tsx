...
const LoginPage = () => {
    ...
    const toggleDarkMode = () => setTheme(!theme || theme === 'light' ? 'dark' : 'light');
    ...
    return (
        ...
        <div className={`min-h-screen flex flex-col font-sans transition-colors duration-500 dark:bg-[#111111] dark:text-gray-100'
            ...
            <main className="min-h-screen flex items-center justify-center p-4 py-20 relative">
                ...
                <div className="w-full max-w-md bg-[#F0F6FA]/80 dark:bg-[#1E1E1E]/60 backdrop-blur-xl border border-white/40 dark:border-white/10 rounded-[2rem] shadow-xl p-8 md:p-10 relative overflow-hidden fade-in">
