    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Link href="/admin/sellers" className="block p-6 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 hover:shadow-md transition-shadow group">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">All Sellers</h2>
                            <p className="text-sm text-gray-500 dark:text-gray-400">Manage sellers and KYC verification</p>
                        </div>
                    </div>
                </Link>
            </div>
