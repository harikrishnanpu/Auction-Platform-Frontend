                  ...
                  <section className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl p-8 md:p-16 mb-20 shadow-lg border border-white/50 dark:border-white/10 relative overflow-hidden flex flex-col lg:flex-row items-center gap-12">
                    <div className="lg:w-1/2 z-10 relative">
                      ...
                      <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-6 leading-tight tracking-tight font-serif">
                        ...
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-500 to-purple-600">For the Future.</span>
                      </h1>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4">
                        <Link className="bg-gray-900 text-white px-8 py-4 text-sm uppercase tracking-widest font-semibold rounded-xl hover:bg-gray-800 transition-all flex items-center justify-center shadow-lg hover:shadow-xl transform hover:-translate-y-0.5" href="/login">
                          Get Started / Login
                        </Link>
                        <Link className="bg-transparent border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white px-8 py-4 text-sm uppercase tracking-widest font-semibold rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-all flex items-center justify-center" href="#">
                          Contact Us
                        </Link>
                      </div>
